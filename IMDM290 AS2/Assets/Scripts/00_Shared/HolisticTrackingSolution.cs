...
namespace Mediapipe.Unity.Holistic
{
    public class HolisticTrackingSolution : ImageSourceSolution<HolisticTrackingGraph>
    {
        ...
        //         for (int i = 0; i < 32; i++)
        //         {
        //             MariaGesture.gen.pose[i].x = eventArgs.value.Landmark[i].X;
        //             MariaGesture.gen.pose[i].y = eventArgs.value.Landmark[i].Y;
        //             MariaGesture.gen.pose[i].z = eventArgs.value.Landmark[i].Z;
        //         }
        //     }
        // }
        ...
        //         for (int i = 0; i < 20; i++)
        //         {
        //             MariaGesture.gen.lefthandpos[i].x = eventArgs.value.Landmark[i].X;
        //             MariaGesture.gen.lefthandpos[i].y = eventArgs.value.Landmark[i].Y;
        //             MariaGesture.gen.lefthandpos[i].z = eventArgs.value.Landmark[i].Z;
        //         }
        //     }
        // }
        ...
        private void OnRightHandLandmarksOutput(object stream, OutputEventArgs<NormalizedLandmarkList> eventArgs)
        {
            ...
            if (eventArgs.value != null)
            {
                for (int i = 0; i < 20; i++)
                {
                    MariaGesture.gen.righthandpos[i].x = eventArgs.value.Landmark[i].X;
                    MariaGesture.gen.righthandpos[i].y = eventArgs.value.Landmark[i].Y;
                    MariaGesture.gen.righthandpos[i].z = eventArgs.value.Landmark[i].Z;
                }
            }
        }
